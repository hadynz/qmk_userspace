...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_CAPS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR, KC_SCRL, KC_PAUS, RGB_TOG, TG(1),
        ...
        KC_ESC, LT(4, KC_A), LCTL_T(KC_R), LALT_T(KC_S), LGUI_T(KC_T), KC_G, KC_M, RGUI_T(KC_N), RALT_T(KC_E), RCTL_T(KC_I), LT(4, KC_O), KC_QUOT,
        ...
        LSFT_T(KC_BSPC), LT(2, KC_TAB), TG(4), RGB_MOD, LT(3, KC_ENT), LSFT_T(KC_SPC)
    ),
    [1] = LAYOUT(
        KC_CAPS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR, KC_SCRL, KC_PAUS, KC_CALC, KC_TRNS,
        LCA(KC_DEL), RGB_TOG, LGUI(KC_TAB), KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, RGB_RMOD, RGB_MOD, RGUI(KC_L),
        KC_LBRC, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_RBRC,
        KC_ESC, LT(4, KC_A), LGUI_T(KC_R), LALT_T(KC_S), LCTL_T(KC_T), KC_D, KC_H, RCTL_T(KC_N), RALT_T(KC_E), RGUI_T(KC_I), LT(4, KC_O), KC_QUOT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
        KC_BSLS, KC_GRV, KC_LEFT, KC_RGHT, KC_UP, KC_DOWN, KC_MINS, KC_EQL,
        LGUI(KC_ENT), LGUI(KC_LEFT), RGUI(KC_RGHT), RGUI(KC_DEL),
        LCA(KC_HOME), LCA(KC_PGUP),
        LSFT_T(KC_BSPC), LT(2, KC_TAB), LCA(KC_END), LCA(KC_PGDN), LT(3, KC_ENT), RSFT_T(KC_SPC)
    ),
    [2] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_1, LCTL_T(KC_2), LALT_T(KC_3), LGUI_T(KC_4), KC_NO, KC_NO, RGUI_T(KC_7), RALT_T(KC_8), RCTL_T(KC_9), KC_0, KC_NO,
        KC_NO, KC_NO, KC_PAST, KC_NO, KC_5, KC_NO, KC_NO, KC_6, KC_COMM, KC_PDOT, KC_PSLS, KC_NO,
    ...
    [3] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, LGUI(KC_ESC), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_NO, KC_NO, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_PERC, KC_NO, KC_NO, KC_CIRC, KC_NO, KC_NO, KC_NO, KC_NO,
