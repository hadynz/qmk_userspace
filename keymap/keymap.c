...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    LCAG(KC_F), HYPR(KC_UP), HYPR(KC_DOWN), LCAG(KC_TAB), HYPR(KC_LEFT), HYPR(KC_RGHT), 
...
// Combo keycodes
const uint16_t PROGMEM test_combo1[] = {KC_Z, KC_X, COMBO_END};
const uint16_t PROGMEM test_combo2[] = {KC_X, KC_C, COMBO_END};
const uint16_t PROGMEM test_combo3[] = {KC_C, KC_D, COMBO_END};
const uint16_t PROGMEM test_combo4[] = {KC_D, KC_V, COMBO_END};
combo_t key_combos[] = {
  COMBO(test_combo1, LGUI(KC_Z)), // undo (command + z)
  COMBO(test_combo2, LGUI(KC_X)), // cut (command + x)
  COMBO(test_combo3, LGUI(KC_C)), // copy (command + c)
  COMBO(test_combo4, LGUI(KC_V)), // paste (command + v)
};
